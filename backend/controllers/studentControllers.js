...
class StudentController {
  async createStudent(req, res, next) {
    ...
    try {
      ...
      await sendMail({
        to: req.body.email,
        subject: `Welcome to GTBITLibrary Management System - Password Reset Required`,
        text: `Dear ${req.body.name},
                    Welcome to the GTBITLibrary Management System! Your account has been created by our admin.
                    Login Credentials:
                    Username/Email: ${req.body.email}
                    Default Password: ${password}
                    You can change your password by login into the system by using above credentials.
                    Thank you for using GTBITLibrary Management System.
                    `,
      });
    } catch (error) {
      return next(error);
